...
const test_floorPrices: Prices = {
  high: 23333,
  medium: 7879
}
let test_hasUser = "yes";
...
export default function Profile(props: {
  ...
  // const { floorPrices, hasUser } = useSelector((state) => ({
  //   floorPrices: state.floorPrices,
  //   hasUser: state.hasUser,
  // }));

  const floorPrices = test_floorPrices;
  const hasUser = test_hasUser;
