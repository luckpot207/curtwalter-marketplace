        ...
        <div className="justify-center flex mb-5">
          <div className="flex items-center text-sm">
            <span className="ml-2 flex">
              {walletUserPublic ? walletUserPublic.username + " | " : null}
              ...
              <ul className="rounded-lg divide-y divide-gray-200 dark:divide-gray-500 border border-gray-200 dark:border-gray-500">
                ...
                >
                  ...
                  <span className="ml-2 whitespace-nowrap">
                    {nFormatter(lamportsToSOL(walletBalance), 4)} SOL
                  </span>
                  <div className="text-right w-full">
                    <span className="rounded text-sm bg-gray-400 text-white dark:text-black p-1">
                      Solana
                    </span>
                  </div>
                </li>
