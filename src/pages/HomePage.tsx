  ...
  return (
    ...
    >
      ...
      {props.show === "volume" ? (
        ...
        <p className="mt-1 text-center">{collection.volume} items</p>
      )}
    </div>
  );
}
...
export function NextArrow({
  ...
  return (
    <div {...props}>
      <div
        className={`flex justify-center items-center bg-lightgray dark:bg-black rounded-2xl purple-bg-on-hover w-12 h-12 ${
          darkMode ? "nav-border" : ""
        } hidden md:flex`}
      >
...
export function PrevArrow({
  ...
  return (
    <div {...props}>
      <div
        className={`hidden md:flex justify-center items-center bg-lightgray dark:bg-black rounded-2xl purple-bg-on-hover w-12 h-12 ${
          darkMode ? "nav-border" : ""
        } `}
      >
                ...
                <div className="relative flex ml-2 ">
                  ...
                  <img
                    ...
                    className={`ml-4 transition-all invert-icon ${
                      trendingListDropdownActive ? "rotate-180" : ""
                    }`}
                  />
