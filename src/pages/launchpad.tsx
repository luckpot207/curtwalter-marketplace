...
import { Button, Spinner } from "../lib/flowbite-react";
...
const token = {
  token: {
    ...
    metadata: {
      ...
      attributes: [{
        trait_type: "length, pop, push, concat",
        value: "f_value"
      }]
    }
  },
  ...
  collection: {
    ...
    description: "10K handcrafted NFT playing cards. Brand & marketing focused # project with the goal of achieving first Hype and then Cult",
    slug: "2011",
  },
  offers: [],
  history: []
  ...
  return (
    <Layout disableFlex={true}>
      <Helmet>
        ...
        />
        <meta property="og:url" content={`http://localhost:3000/t`} />
        <meta
          name="twitter:title"
          content={`Alpha Art | ${nft.token?.metadata?.name}`}
        />
      ...
      <div className="mx-auto py-8 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <div className="lg:grid lg:grid-rows-1 lg:grid-cols-7 lg:gap-x-8 lg:gap-y-10 xl:gap-x-16">
          ...
          <div className="max-w-2xl mx-auto mt-14 sm:mt-16 lg:max-w-none lg:mx-0 lg:mt-0 lg:row-end-2 lg:row-span-2 lg:col-span-4">
            ...
            <div className="flex justify-center w-full md:justify-start mt-5">
              {isConnected?
                <Button
                  size="md"
                  color="dark"
