...
export default function Collection() {
  ...
  return (
    <div className="bg-white flex flex-col overflow-x-hidden h-screen">
      <MobileFilters
      ...
      <div className="flex flex-1 sm:px-6 lg:px-8">
        ...
        <main className="flex-1 px-4 sm:px-6 lg:px-8 pt-6 pb-6">
          ...
          {expectedTokenCount > 0 && !progress && (
            <h3 className="text-xs font-semibold tracking-wide text-gray-500 mb-4">
              {expectedTokenCount} Items
            </h3>
          )}
          {expectedTokenCount === 0 && !progress && (
            <h3 className="text-base font-semibold w-full text-center tracking-wide text-gray-500 mt-8">
              No Result
            </h3>
          )}
          {progress ? (
            <div className="animate-pulse">
              <div className="mb-5 h-4 w-20 overflow-hidden bg-gray-200 rounded-sm" />
