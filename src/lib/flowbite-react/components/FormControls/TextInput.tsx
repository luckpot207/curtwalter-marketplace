...
type Size = 'sm' | 'md' | 'lg';
type Color = 'base' | 'green' | 'red' | 'zinc'; // ADDED "zinc" 8.May 2022
...
const colorClasses: Record<Color, { input: string; helperText: string }> = {
  ...
  zinc: {
    input:
      'border-zinc-500 bg-zinc-50 text-zinc-900 placeholder-zinc-700 focus:border-zinc-500 focus:ring-zinc-500 dark:border-zinc-400 dark:bg-zinc-100 dark:focus:border-zinc-500 dark:focus:ring-zinc-500',
    helperText: 'text-zinc-600 dark:text-zinc-500',
  },
};
